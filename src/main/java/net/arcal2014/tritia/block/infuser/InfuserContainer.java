...
import net.arcal2014.tritia.init.ModContainerTypes;
...
public class InfuserContainer extends Container {
    ...
    public InfuserContainer (int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new InfuserTileEntity(), new IntArray(buffer.readByte()));
    }

    public InfuserContainer(int id, PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
       super(ModContainerTypes.INFUSER.get(), id);
       this.inventory = inventory;
       this.fields = fields;

       this.addDataSlot((IntReferenceHolder) fields);
    ...
    public  int getProgressArrowScale() {
        ...
        if (progress > 0) {
            return progress * 24 / InfuserTileEntity.WORK_TIME;
        }
        return 0;
    }
